...
for n in range(1, number+1):
    ...
    threshold = 100  # Threshold for detecting a sitting down or standing up event (in pixels)
    action_events = []
    ...
    for i in range(30, len(y_positions)):
...
# # Loop through all couch vector files from couch1 to couch1
# for i in range(1, 8):
